...
class BlockMiddlewaresix:
    ...
    def __call__(self, request):
        ...
        "msn",
        "hotmail",
            # Add all banned user agent substrings here...
        ]
        ...
        # Check if user agent contains banned substrings
        for ua_pattern in banned_user_agents:
